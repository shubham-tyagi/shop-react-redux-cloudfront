...
resource "azurerm_windows_function_app" "imports_service" {
  ...
  app_settings = {
    ...
    WEBSITE_CONTENTSHARE                     = azurerm_storage_account.imports_service_fa.name
  }
...
resource "azurerm_storage_container" "import_uploaded" {
  name                  = "uploaded"
  storage_account_name  = azurerm_storage_account.imports_service_fa.name
  container_access_type = "private"
}

resource "azurerm_storage_container" "import_parsed" {
  name                  = "parsed"
  storage_account_name  = azurerm_storage_account.imports_service_fa.name
  container_access_type = "private"
}